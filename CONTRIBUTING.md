...
- Commit messages: try to follow the [conventional commits](https://www.conventionalcommits.org/en/v1.0.0/), although we are flexible about it (just do your best to name your changes intuitively for others!).
...
- Pull requests: Make sure you pass all the Developers checklist (lintr, tests, docs, version bump). Add at least two reviewers from the core team (authors listed in the [DESCRIPTION file](https://github.com/pharmaverse/aNCA/blob/main/DESCRIPTION)). If you need help, just ask in the issue thread and tag any of the core team.
