    ...
    accordion(
      ...
      accordion_panel(
        ...
        virtualSelectInput(
          ...
          # TODO (Gerardo): This should be perhaps indicated in the metadata_nca_variables
          # Depending on the type of study
          selected = c(
            "aucinf.obs", "aucinf.obs.dn", "auclast", "auclast.dn",
            "cmax", "cmax.dn", "clast.obs", "clast.obs.dn",
            "tlast", "tmax", "half.life", "cl.obs", "vss.obs", "vz.obs",
            "mrt.last", "mrt.obs", "lambda.z", "lambda.z.n.points", "r.squared",
  ...
  moduleServer(id, function(input, output, session) {
    ...
    settings <- reactive({
      ...
      list(
        ...
        parameter_selection = input$nca_parameters,
