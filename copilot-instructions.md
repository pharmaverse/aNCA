...
This is an R package for automated Non-Compartmental Analysis (NCA) with
...
All PRs must pass: lintr, unit tests, test coverage, man page
generation, and spell check.

## Additional Context

See `AGENTS.md` for full development guidelines. See
`.github/instructions/` for path-specific coding conventions. See
`.github/skills/` for reusable agent workflows.
