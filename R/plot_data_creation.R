...
exploration_meanplot <- function(
  ...
  x_lab <- plot_build$labels$x
  y_lab <- plot_build$labels$y
  title <- plot_build$labels$title

  x_lab <- paste("Nominal", plot_build$labels$x)
  y_lab <- paste("Mean", plot_build$labels$y)
