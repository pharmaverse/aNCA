...
.onLoad <- function(libname, pkgname) {
  ...
  utils::globalVariables(c(
    ...
    "PPTESTCD_cdisc", "PPTESTCD_unit", "RANGE", "RRLTU", "Ratio", "Ratio_Type", "Route", "SD",
    "SD_max", "SD_min", "SE", "Spec1_Label", "Spec1_Units", "Spec1_Value", "Spec2_Label",
    "Spec2_Units", "Spec2_Value", "STUDYID", "SUBJID", "TIME", "USUBJID", "Unit", "Value",
    "data", "digits", "dose_time", "end", "end_dose", "exclude", "exclude_half.life",
