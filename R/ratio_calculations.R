...
#' @param spec1 A character string specifying the value for the first specimen type in the matrix_col.
#' @param spec2 A character string specifying the value for the second specimen type in the matrix_col.
#' 
...
#' @param groups A character vector of grouping variables to use for the analysis.
#'                  Must include TIME, USUBJID, and optionally, other grouping variables.
#' @param spec1 A character string specifying the value for the first specimen type(s) in the matrix_col.
#' @param spec2 A character string specifying the value for the second specimen type(s) in the matrix_col.
#' 
#' @returns A data frame containing the ratios.
#' 
#' @import dplyr
