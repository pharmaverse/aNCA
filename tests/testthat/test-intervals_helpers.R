...
describe("interval_add_impute", {
  ...
  it("does not create duplicates but instead removes original ones and then adds impute method based on after", {
...
describe("interval_remove_impute", {
  ...
  it("does not modify data if global impute & column are missing", {
    ...
    res <- suppressWarnings(interval_remove_impute(d_no_imp$intervals, target_impute = "start_conc0"))
