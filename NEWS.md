...
* All-missing input columns now use their metadata-defined types during
  preprocessing, so optional numeric fields such as `VOLUME` remain numeric
  when uploaded empty (#1506)
