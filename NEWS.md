...
### Export & Output
* Added "Analyte Comparison" slide type under Summary Slides in the export customisation modal; generates mean plots faceted by DOSETRT x PARAM for both PPTX and QMD exports (#1174)
