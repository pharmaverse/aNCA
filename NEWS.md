...
* CDISC ZIP export now includes a `Pre_Specs.xlsx` file with variable-level metadata for each selected dataset (#807)
* Switched xlsx writing from `openxlsx2` to `writexl` for lighter dependencies (#807)
