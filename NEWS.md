...
* All 33 TLG entries offer Title, Subtitle and Footnote controls, with catalog-based default wording. Summary tables display these labels above and below the table, and the urine concentration listing title is editable (#1476)
* Summary-table subtitles follow the selected split variables. PK-parameter plot subtitles identify the analyte, specimen, visit and parameter units for each plot, with long text wrapped (#1476)
