...
* Added dose-normalised slides to the PPT/QMD export. Each group now includes an optional
  "Dose-Normalised Plots" summary slide (dose-normalised mean plot + parameter table) and
  an optional "Dose-Normalised PK Parameters" individual slide. Both are controlled via the
  Customise Slides modal and default to CMAXD, AUCLSTD, and AUCIFOD (#1054).
