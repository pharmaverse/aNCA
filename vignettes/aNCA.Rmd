...
### Saving Plots to the Report

Each exploration plot (Individual, Mean, and PK/Dose QC) has an **Add to Report** button in its sidebar. Clicking this button saves a snapshot of the current plot to the ZIP export. Saved plots are numbered incrementally (e.g., `individualplot1.png`, `individualplot2.png`) alongside the default plot (`individualplot.png`). The default plot always reflects the most recent view, while the numbered snapshots preserve the state at the time they were saved.
