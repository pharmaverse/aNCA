...
<image src="images/get_started/gifs/upload_dataset.gif" alt="Data upload"/ width="100%">
...
variable <- c("STUDYID *", "USUBJID *", "ATPTREF *", "TRT01A", "TRT01P",
              ...
              "DRUG *", "ROUTE *", "DOSEA *", "ADOSEDUR",
              "AFRLT *", "ARRLT *", "NFRLT *", "NRRLT *",
              "DOSETRT *", "ROUTE *", "DOSEA *", "ADOSEDUR", "AFRLT *", "ARRLT *", "NFRLT *",
...
datatable <- DT::datatable(dataformat, rownames = FALSE,
  ...
  formatStyle(columns = 1,
              fontWeight = styleEqual(c("Grouping Identifiers", "Sample Variables",
                                        "Dose Variables", "Time Variables"), rep("bold", 4)))
datatable
```
</details>
...
<image src="images/get_started/gifs/examine_data_next.gif" alt="Mapping"/ /width="100%"> 

If you want to change the data by adding filters, click the *Add Filter* button.

<image src="images/get_started/gifs/adding_filters.gif" alt="Adding filters"/width="100%">
...
<image src="images/get_started/gifs/data_mapping.gif" alt="Mapping"/ /width="100%"> 
...
<image src="images/get_started/gifs/exploratory_plot_types.gif" alt="Mapping"/ /width="100%">
...
<image src="images/get_started/gifs/exploratory_graph_toggles.gif" alt="Mapping"/ /width="100%">

Once you've made your choices you can download, save and inspect the visualizations in the top right corner of the plot.

<image src="images/get_started/gifs/exploration_options.gif" alt="Mapping"/ /width="100%">
...
<image src="images/get_started/gifs/download_settings_nca.gif" alt="NCA settings"/ width="100%">
...
<image src="images/get_started/gifs/slope_selector_exclusion_remove.gif" alt="NCA settings"/ width="100%">

#### Via the Plots

For in-app guidance, you can click the [?]{.help-button} button.

<image src="images/get_started/gifs/nca_setup_slope_selector.gif" alt="NCA settings"/ width="100%">
...
<image src="images/get_started/gifs/run_nca_button.gif" alt="NCA settings"/ width="100%">
...
<image src="images/get_started/gifs/nca_results_download.gif" alt="NCA settings"/ width="100%">
...
<image src="images/get_started/gifs/descriptive_statistics.gif" alt="NCA settings"/ width="100%">

### Parameter Datasets

In the Parameter Datasets tab you can see and export the ADPP, ADNCA, and PP datasets.

<image src="images/get_started/gifs/parameter_datasets.gif" alt="Parameter Datasets"/ width="100%">
...
<image src="images/get_started/gifs/matrix_ratios.gif" alt="Parameter Datasets"/ width="100%">
...
<image src="images/get_started/gifs/tlg_selection_add.gif" alt="Default TLG table"/ width="100%">

You can also remove unwanted entries by selecting them and clicking **Remove TLG**.

<image src="images/get_started/gifs/tlg_selection_remove.gif" alt="Default TLG table"/ width="100%">
...
<image src="images/get_started/gifs/tlg_sidebar.gif" alt="TLG navigation"/ width="100%">

Also, in each tab using the widgets at the top you can specify the number of entries per page and change the pages.

<image src="images/get_started/gifs/tlg_widgets.gif" alt="TLG pages"/ width="100%">

Lastly, the widgets on the right are used for customizing the resulting reports.

<image src="images/get_started/gifs/tlg_customizing_reports.gif" alt="TLG customization"/ width="100%">
