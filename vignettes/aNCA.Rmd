...
| **Sample variables** | PARAM | Analyte | character |
...
Review the data and ensure that the columns have been mapped correctly, and all your filters have been applied.
...
<img src="images/get_started/06.png" alt="NCA settings"/>
...
For in-app guidance, you can click the <span class="help-button">?</span> button.
...
You can always click on the <span class="help-button">?</span> button for help.
