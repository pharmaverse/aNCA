...
aNCA automatically flags NCA results that may be unreliable. Flags are stored in the output and highlighted in the UI.

**Common Flags**:

- **Half-life flags**: 
  - `r.squared < 0.9`: Poor fit of terminal slope
  - `span.ratio < 2`: Insufficient span of half-life
  - `adj.r.squared < 0.8`: Poor adjusted R²

**Implementation**: Controlled by PKNCA's built-in rules

**Reference**: [PKNCA Exclusions and Checks](https://billdenney.github.io/pknca/articles/Half-life.html)
...
**PKNCA Function**: `pk.calc.half.life()` and `pk.calc.thalf.eff()`
