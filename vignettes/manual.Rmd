...
| 4. NCA Settings | [NCA Settings](#4-nca-settings) |
| 5. Running NCA | [Running NCA](#5-running-nca) |
...
## 4.1 Data Imputation Rules {#data-imputation-rules}
...
### 4.1.1 Start Concentration Imputation: `create_start_impute()`
...
### 4.1.2 BLQ (Below Limit of Quantification) Imputation
...
## 4.2 BLQ (Below Limit of Quantification) Handling
...
### 4.3.1 Integration Methods (Between Concentrations)
...
### 4.3.2 Extrapolation Methods (After Last Measurement)
