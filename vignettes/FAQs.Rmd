...
If you'd like this feature built into the app (an option to choose nominal/actual/conditional), please open an enhancement request on the [GitHub repository](https://github.com/pharmaverse/aNCA/issues).
</details>
