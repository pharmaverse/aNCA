...
$$\text{Ratio} = \frac{\text{TestParameter}[\text{TestGroup}]}{\text{RefParameter}[\text{RefGroup}]} \times \text{AdjFactor}$$
...
$$MR_{CMAX} = \frac{CMAX_{\text{metabolite}}}{CMAX_{\text{parent}}} \times AdjFactor$$
...
$$RA_{CMAX} = \frac{CMAX_{\text{test group}}}{CMAX_{\text{ref group}}} \times AdjFactor$$
