...
Note: Ratio calculations are only available for parameters that have been requested via the **Parameters** tab. If a parameter is not requested, it will not be available for ratio calculations.
