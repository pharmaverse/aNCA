...
Ratio calculations are implemented in aNCA independently of PKNCA. They operate
on the computed NCA results — dividing one parameter value by another across
groups — rather than being part of the core NCA engine.
