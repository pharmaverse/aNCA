...
# aNCA — Design & Architecture

This document captures the high-level architecture, data flow, and key design decisions for the aNCA package and its embedded Shiny application. It is intended to help maintainers and contributors quickly understand how the system is organized, where responsibilities live, and why important choices were made.
